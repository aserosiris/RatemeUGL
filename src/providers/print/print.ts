...
export class PrintProvider {
  ...
  ProveedorimpresionNotaVta(address,cliente,clavesVta,tipoVentaCliente, reconocimientoVta,subtotalVta,IVAVta, totalFinal,KLAcumVta,IEPSVta, rutamail, tipoImpresion )
  {
