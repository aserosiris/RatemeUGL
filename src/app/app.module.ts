...
import { BluetoothSerial } from '@ionic-native/bluetooth-serial'; //PARA IMPRIMIR SE DEBE AGREGAR ESTA LINEA
...
@NgModule({
  ...
  providers: [
    ...
    BluetoothSerial  //PARA IMPRIMIR SE DEBE AGREGAR ESTA LINEA
